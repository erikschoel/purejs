...
CALL stp_upsertDimensionRecord('sys.app.item', 'main', @menu_id);
...
CALL stp_upsertRelationRecord(func_getDimensionID('sys.app.item.item'), @menu_id, func_getRecordID('sys.app.item', 'sys.attr.code', 'system'), 0, @rela_id);
...
CALL stp_upsertRelationRecord(func_getDimensionID('sys.app.item.item'), func_getMadrId(CONCAT('mare_', @rela_id)), func_getRecordID('sys.app.item', 'sys.attr.code', 'admin/datamodel'), 0, @rela_subid);
...
CALL stp_upsertRelationRecord(func_getDimensionID('sys.app.item.item'), func_getMadrId(CONCAT('mare_', @rela_id)), func_getRecordID('sys.app.item', 'sys.attr.code', 'admin/viewmodel'), 0, @rela_subid);

CALL stp_upsertDimensionRecord('sys.app.item', 'search', @itm_id);
CALL stp_upsertDimensionRecordValue(@itm_id, 'sys.attr.desc', 'sys.lang.nl', 'Search', 0, @attr_id);
CALL stp_upsertRelationRecord(func_getDimensionID('sys.app.item.item'), @menu_id, func_getRecordID('sys.app.item', 'sys.attr.code', 'search'), 0, @rela_id);
...
CALL stp_upsertRelationRecord(func_getDimensionID('sys.app.item.item'), @menu_id, func_getRecordID('sys.app.item', 'sys.attr.code', 'account'), 0, @rela_id);
...
CALL stp_upsertRelationRecord(func_getDimensionID('sys.app.item.item'), func_getMadrId(CONCAT('mare_', @rela_id)), func_getRecordID('sys.app.item', 'sys.attr.code', 'settings'), 0, @rela_subid);
...
CALL stp_upsertRelationRecord(func_getDimensionID('sys.app.item.item'), func_getMadrId(CONCAT('mare_', @rela_id)), func_getRecordID('sys.app.item', 'sys.attr.code', 'logout'), 0, @rela_subid);
...
WHERE madr_fk_dimension = func_getDimensionID('sys.app.item')
